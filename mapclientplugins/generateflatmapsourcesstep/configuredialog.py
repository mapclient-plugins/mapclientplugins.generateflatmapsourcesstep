...
from mapclientplugins.generateflatmapsourcesstep.ui_configuredialog import Ui_ConfigureDialog
...
class ConfigureDialog(QtWidgets.QDialog):
    ...
    def validate(self):
        ...
        prefix_valid = len(self._ui.lineEditPrefix.text()) > 0
        self._ui.lineEditPrefix.setStyleSheet(DEFAULT_STYLE_SHEET if prefix_valid else INVALID_STYLE_SHEET)

        return valid and prefix_valid
